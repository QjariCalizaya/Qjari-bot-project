...
def chat_once(messages: List[Dict],
    ...
    print("DEBUG sending request to:", OPENROUTER_API_URL)
    ...
    print("DEBUG status code:", request.status_code)

    print("DEBUG raw text:", request.text[:500])  # <<< AQUI
    ...
    try:
        ...
        raise OpenRouterError(500, f"Неожиданная структура ответа OpenRouter: {e}")
